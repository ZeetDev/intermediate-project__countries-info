...
const typeMap: any = {
	...
	CapitalInfo: o([{ json: "latlng", js: "latlng", typ: a(3.14) }], false),
	Car: o(
		[
	...
	Currencies: o([{ json: "ERN", js: "ERN", typ: r("Ern") }], false),
	Ern: o(
		[
	...
	NativeName: o(
		[
			{ json: "ara", js: "ara", typ: r("Translation") },
			{ json: "eng", js: "eng", typ: r("Translation") },
			{ json: "tir", js: "tir", typ: r("Translation") },
		],
		false,
	),
	Translation: o(
	...
	PostalCode: o(
		[
			{ json: "format", js: "format", typ: null },
			{ json: "regex", js: "regex", typ: null },
		],
		false,
	),
};
